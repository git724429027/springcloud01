...
import com.wang.myhandler.CustomerBlockHandler;
...
public class RateLimitController {
    ...
    @SentinelResource(value = "customerBlockHandler", blockHandlerClass = CustomerBlockHandler.class, blockHandler = "handlerException2")//blockHandlerClass = CustomerBlockHandler.class,
